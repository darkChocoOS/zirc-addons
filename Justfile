export image_name := env("IMAGE_NAME", "zirc-addons") # output image name, usually same as repo name, change as needed
export repo_organization := env("REPO_ORGANIZATION", "darkchocoOS") # usually same as github username
export image_desc := env("IMAGE_DESC", "personal addons to zirconium-dev/zirconium")
export image_keywords := env("IMAGE_KEYWORDS", "bootc,niri")
